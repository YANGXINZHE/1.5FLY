...
int i2cdevInit(I2C_TypeDef *I2Cx)
{
  ...
  if (I2Cx == I2C1)
  {
    ...
    NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = NVIC_I2C_DMA_CHANNEL_TX_P ;
    NVIC_InitStructure.NVIC_IRQChannelSubPriority = NVIC_I2C_DMA_CHANNEL_TX_S ;
    NVIC_InitStructure.NVIC_IRQChannelCmd = ENABLE;
    NVIC_Init(&NVIC_InitStructure);

    // Enable the DMA1 channel7 Interrupt
    NVIC_InitStructure.NVIC_IRQChannel = DMA1_Channel7_IRQn;
    NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = NVIC_I2C_DMA_CHANNEL_RX_P;
    NVIC_InitStructure.NVIC_IRQChannelSubPriority = NVIC_I2C_DMA_CHANNEL_RX_S;
    NVIC_InitStructure.NVIC_IRQChannelCmd = ENABLE;
    NVIC_Init(&NVIC_InitStructure);
