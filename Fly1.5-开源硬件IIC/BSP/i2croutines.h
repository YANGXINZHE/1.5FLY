...
//ANOTech_taobao_com_I2C1_INIT(0xA6,400000,2,1,1,3,3);	
//(u8 ownadd, u32 speed, u8 nvic_g, u8 nvic_er_p, u8 nvic_er_s, u8 nvic_ev_p, u8 nvic_ev_s);    NVIC_InitStructure.NVIC_IRQChannel = I2C1_EV_IRQn;
 
#define NVIC_I2C_EV_P  0
#define NVIC_I2C_EV_S  0

#define NVIC_I2C_ER_P  0
#define NVIC_I2C_ER_S  0

#define NVIC_I2C_DMA_CHANNEL_TX_P  0
#define NVIC_I2C_DMA_CHANNEL_TX_S  0

#define NVIC_I2C_DMA_CHANNEL_RX_P  0
#define NVIC_I2C_DMA_CHANNEL_RX_S  0
