...
void I2C_LowLevel_Init(I2C_TypeDef* I2Cx)
{
  ...
  if (I2Cx == I2C1)
  {
    ...
    NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = NVIC_I2C_EV_P;
    NVIC_InitStructure.NVIC_IRQChannelSubPriority =NVIC_I2C_EV_S;
    NVIC_InitStructure.NVIC_IRQChannelCmd = ENABLE;
    NVIC_Init(&NVIC_InitStructure);
    NVIC_InitStructure.NVIC_IRQChannel = I2C1_ER_IRQn;
    NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority =NVIC_I2C_ER_S;
    NVIC_InitStructure.NVIC_IRQChannelSubPriority = NVIC_I2C_ER_S;
	NVIC_Init(&NVIC_InitStructure);
  }
  else /* I2Cx = I2C2 */
  {
...
// ANO_TC_I2C2_INIT(0xA6,400000,1,1,3,3);//ownadd：器件地址，speed：iic速度，nvic_er_p：iic错误中断抢占优先级。。依此类推
